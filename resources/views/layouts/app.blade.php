...
<head>
  ...
  <title>{APES} - Aplikasi Perpustakaan.COM</title>
  <!-- plugins:css -->
      ...
      <div class="main-panel">
        ...
        <footer class="footer">
          <div class="container-fluid clearfix">
            <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Code With &hearts; Surabaya Indonesia</span>
          </div>
        </footer>
        <!-- partial -->
      </div>
