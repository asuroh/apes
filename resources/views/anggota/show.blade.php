            ...
            <div class="col-md-12 d-flex align-items-stretch grid-margin">
              <div class="row flex-grow">
                <div class="col-12">
                  <div class="card">
                    <div class="card-body">
                      <h4 class="card-title">Detail <b>{{$data->name}}</b></h4>
                      <form class="forms-sample">
                        ...
                        <div class="form-group{{ $errors->has('nama') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="nama" type="text" class="form-control" name="nama" value="{{ $data->name }}" readonly>
                                @if ($errors->has('nama'))
                        ...
                        <div class="form-group{{ $errors->has('npm') ? ' has-error' : '' }}">
                            <label for="npm" class="col-md-4 control-label">Nomor Identitas</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group{{ $errors->has('user_id') ? ' has-error' : '' }} " style="margin-bottom: 20px;">
                            ...
                            <div class="col-md-6">
                            <input id="username" type="text" class="form-control" name="username" value="{{ $data->username }}" readonly="">
                            </div>
                        </div>
